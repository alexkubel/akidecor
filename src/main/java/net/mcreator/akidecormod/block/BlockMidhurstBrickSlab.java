...
public class BlockMidhurstBrickSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:midhurst_brick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:midhurst_brick_slab_double")
	public static final Block block_slab_double = null;
	public BlockMidhurstBrickSlab(ElementsAkidecorMod instance) {
		super(instance, 99);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("midhurst_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("midhurst_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:midhurst_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("midhurst_brick_slab");

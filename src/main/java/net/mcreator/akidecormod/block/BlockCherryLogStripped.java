...
public class BlockCherryLogStripped extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:cherrylogstripped")
	public static final Block block = null;
	public BlockCherryLogStripped(ElementsAkidecorMod instance) {
		super(instance, 201);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cherrylogstripped"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:cherrylogstripped", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("cherrylogstripped");

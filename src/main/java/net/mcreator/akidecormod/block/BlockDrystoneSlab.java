...
public class BlockDrystoneSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:drystone_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:drystone_slab_double")
	public static final Block block_slab_double = null;
	public BlockDrystoneSlab(ElementsAkidecorMod instance) {
		super(instance, 83);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("drystone_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("drystone_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:drystone_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("drystone_slab");

...
public class BlockGratestoneThiccWall extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:gratestonethiccwall")
	public static final Block block = null;
	public BlockGratestoneThiccWall(ElementsAkidecorMod instance) {
		super(instance, 66);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gratestonethiccwall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:gratestonethiccwall", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("gratestonethiccwall");

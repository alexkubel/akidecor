...
public class BlockMudBrickSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:mudbrickslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:mudbrickslab_double")
	public static final Block block_slab_double = null;
	public BlockMudBrickSlab(ElementsAkidecorMod instance) {
		super(instance, 187);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mudbrickslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("mudbrickslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:mudbrickslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.GROUND);
			setUnlocalizedName("mudbrickslab");

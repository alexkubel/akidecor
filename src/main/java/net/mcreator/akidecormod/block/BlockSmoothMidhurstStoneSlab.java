...
public class BlockSmoothMidhurstStoneSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:smooth_midhurst_stone_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:smooth_midhurst_stone_slab_double")
	public static final Block block_slab_double = null;
	public BlockSmoothMidhurstStoneSlab(ElementsAkidecorMod instance) {
		super(instance, 149);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("smooth_midhurst_stone_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("smooth_midhurst_stone_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:smooth_midhurst_stone_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("smooth_midhurst_stone_slab");

...
public class BlockTuffPolishedSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:tuffpolishedslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:tuffpolishedslab_double")
	public static final Block block_slab_double = null;
	public BlockTuffPolishedSlab(ElementsAkidecorMod instance) {
		super(instance, 250);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tuffpolishedslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("tuffpolishedslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:tuffpolishedslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tuffpolishedslab");

...
public class BlockBlackenedBrickLargeSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:blackened_brick_large_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:blackened_brick_large_slab_double")
	public static final Block block_slab_double = null;
	public BlockBlackenedBrickLargeSlab(ElementsAkidecorMod instance) {
		super(instance, 111);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("blackened_brick_large_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("blackened_brick_large_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:blackened_brick_large_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("blackened_brick_large_slab");

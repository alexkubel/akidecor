...
public class BlockHighlandTuffThiccWall extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:highland_tuff_thicc_wall")
	public static final Block block = null;
	public BlockHighlandTuffThiccWall(ElementsAkidecorMod instance) {
		super(instance, 332);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("highland_tuff_thicc_wall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:highland_tuff_thicc_wall", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("highland_tuff_thicc_wall");

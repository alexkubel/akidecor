...
public class BlockSmoothHighlandTuffSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:smooth_highland_tuff_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:smooth_highland_tuff_slab_double")
	public static final Block block_slab_double = null;
	public BlockSmoothHighlandTuffSlab(ElementsAkidecorMod instance) {
		super(instance, 145);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("smooth_highland_tuff_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("smooth_highland_tuff_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:smooth_highland_tuff_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("smooth_highland_tuff_slab");

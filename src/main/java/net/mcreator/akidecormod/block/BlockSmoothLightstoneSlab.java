...
public class BlockSmoothLightstoneSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:smoothlightstoneslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:smoothlightstoneslab_double")
	public static final Block block_slab_double = null;
	public BlockSmoothLightstoneSlab(ElementsAkidecorMod instance) {
		super(instance, 56);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("smoothlightstoneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("smoothlightstoneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:smoothlightstoneslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("smoothlightstoneslab");

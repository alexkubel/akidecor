...
public class BlockSootedBrickSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:sooted_brick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:sooted_brick_slab_double")
	public static final Block block_slab_double = null;
	public BlockSootedBrickSlab(ElementsAkidecorMod instance) {
		super(instance, 95);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sooted_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("sooted_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:sooted_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("sooted_brick_slab");

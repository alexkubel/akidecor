...
public class BlockPortlandStoneSmallBrickSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:portland_stone_small_brick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:portland_stone_small_brick_slab_double")
	public static final Block block_slab_double = null;
	public BlockPortlandStoneSmallBrickSlab(ElementsAkidecorMod instance) {
		super(instance, 136);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("portland_stone_small_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("portland_stone_small_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:portland_stone_small_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("portland_stone_small_brick_slab");

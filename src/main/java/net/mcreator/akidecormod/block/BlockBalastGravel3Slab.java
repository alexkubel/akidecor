...
public class BlockBalastGravel3Slab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:balastgravel3slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:balastgravel3slab_double")
	public static final Block block_slab_double = null;
	public BlockBalastGravel3Slab(ElementsAkidecorMod instance) {
		super(instance, 75);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("balastgravel3slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("balastgravel3slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:balastgravel3slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.GROUND);
			setUnlocalizedName("balastgravel3slab");

...
public class BlockBrick3slab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:brick3slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:brick3slab_double")
	public static final Block block_slab_double = null;
	public BlockBrick3slab(ElementsAkidecorMod instance) {
		super(instance, 193);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brick3slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("brick3slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:brick3slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("brick3slab");

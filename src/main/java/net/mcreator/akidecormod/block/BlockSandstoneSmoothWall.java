...
public class BlockSandstoneSmoothWall extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:sandstonesmoothwall")
	public static final Block block = null;
	public BlockSandstoneSmoothWall(ElementsAkidecorMod instance) {
		super(instance, 149);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sandstonesmoothwall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:sandstonesmoothwall", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.SAND);
			setUnlocalizedName("sandstonesmoothwall");

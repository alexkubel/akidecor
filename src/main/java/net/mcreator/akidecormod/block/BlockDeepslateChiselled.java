...
public class BlockDeepslateChiselled extends ElementsAkidecorMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("deepslatechiselled"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:deepslatechiselled", "inventory"));
	}
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("deepslatechiselled");

...
public class BlockDioriteBallastSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:diorite_ballast_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:diorite_ballast_slab_double")
	public static final Block block_slab_double = null;
	public BlockDioriteBallastSlab(ElementsAkidecorMod instance) {
		super(instance, 318);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("diorite_ballast_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("diorite_ballast_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:diorite_ballast_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("diorite_ballast_slab");

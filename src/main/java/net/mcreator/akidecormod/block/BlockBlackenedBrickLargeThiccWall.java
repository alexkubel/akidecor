...
public class BlockBlackenedBrickLargeThiccWall extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:blackened_brick_large_thicc_wall")
	public static final Block block = null;
	public BlockBlackenedBrickLargeThiccWall(ElementsAkidecorMod instance) {
		super(instance, 324);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("blackened_brick_large_thicc_wall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:blackened_brick_large_thicc_wall", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("blackened_brick_large_thicc_wall");

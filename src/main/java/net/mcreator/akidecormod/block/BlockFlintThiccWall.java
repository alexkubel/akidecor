...
public class BlockFlintThiccWall extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:flintthiccwall")
	public static final Block block = null;
	public BlockFlintThiccWall(ElementsAkidecorMod instance) {
		super(instance, 147);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("flintthiccwall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:flintthiccwall", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("flintthiccwall");

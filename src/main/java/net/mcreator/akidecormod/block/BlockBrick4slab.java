...
public class BlockBrick4slab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:brick4slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:brick4slab_double")
	public static final Block block_slab_double = null;
	public BlockBrick4slab(ElementsAkidecorMod instance) {
		super(instance, 16);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brick4slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("brick4slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:brick4slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("brick4slab");

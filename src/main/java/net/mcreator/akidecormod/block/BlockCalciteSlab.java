...
public class BlockCalciteSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:calciteslab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("calciteslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("calciteslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:calciteslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("calciteslab");

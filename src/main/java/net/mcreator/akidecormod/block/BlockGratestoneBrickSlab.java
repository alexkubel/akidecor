...
public class BlockGratestoneBrickSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:gratestonebrickslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:gratestonebrickslab_double")
	public static final Block block_slab_double = null;
	public BlockGratestoneBrickSlab(ElementsAkidecorMod instance) {
		super(instance, 39);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gratestonebrickslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("gratestonebrickslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:gratestonebrickslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("gratestonebrickslab");

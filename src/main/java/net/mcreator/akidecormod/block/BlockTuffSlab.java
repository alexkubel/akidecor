...
public class BlockTuffSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:tuffslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:tuffslab_double")
	public static final Block block_slab_double = null;
	public BlockTuffSlab(ElementsAkidecorMod instance) {
		super(instance, 243);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tuffslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("tuffslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:tuffslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tuffslab");

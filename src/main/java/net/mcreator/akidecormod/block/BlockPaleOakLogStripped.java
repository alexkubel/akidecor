...
public class BlockPaleOakLogStripped extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:pale_oak_log_stripped")
	public static final Block block = null;
	public BlockPaleOakLogStripped(ElementsAkidecorMod instance) {
		super(instance, 347);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pale_oak_log_stripped"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:pale_oak_log_stripped", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("pale_oak_log_stripped");

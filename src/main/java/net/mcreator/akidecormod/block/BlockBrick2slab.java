...
public class BlockBrick2slab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:brick2slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:brick2slab_double")
	public static final Block block_slab_double = null;
	public BlockBrick2slab(ElementsAkidecorMod instance) {
		super(instance, 8);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brick2slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("brick2slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:brick2slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("brick2slab");

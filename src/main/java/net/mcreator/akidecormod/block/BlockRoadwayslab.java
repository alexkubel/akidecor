...
public class BlockRoadwayslab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:roadwayslab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("roadwayslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("roadwayslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:roadwayslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("roadwayslab");

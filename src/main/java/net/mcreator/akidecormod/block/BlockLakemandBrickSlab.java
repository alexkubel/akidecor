...
public class BlockLakemandBrickSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:lakemand_brick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:lakemand_brick_slab_double")
	public static final Block block_slab_double = null;
	public BlockLakemandBrickSlab(ElementsAkidecorMod instance) {
		super(instance, 85);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lakemand_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("lakemand_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:lakemand_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("lakemand_brick_slab");

...
public class BlockOakwoodSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:oakwood_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:oakwood_slab_double")
	public static final Block block_slab_double = null;
	public BlockOakwoodSlab(ElementsAkidecorMod instance) {
		super(instance, 369);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("oakwood_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("oakwood_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:oakwood_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("oakwood_slab");

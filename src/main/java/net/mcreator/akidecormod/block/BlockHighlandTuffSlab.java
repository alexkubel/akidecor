...
public class BlockHighlandTuffSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:highland_tuff_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:highland_tuff_slab_double")
	public static final Block block_slab_double = null;
	public BlockHighlandTuffSlab(ElementsAkidecorMod instance) {
		super(instance, 112);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("highland_tuff_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("highland_tuff_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:highland_tuff_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("highland_tuff_slab");

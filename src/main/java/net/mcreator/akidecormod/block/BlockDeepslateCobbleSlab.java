...
public class BlockDeepslateCobbleSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:deepslatecobbleslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:deepslatecobbleslab_double")
	public static final Block block_slab_double = null;
	public BlockDeepslateCobbleSlab(ElementsAkidecorMod instance) {
		super(instance, 175);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("deepslatecobbleslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("deepslatecobbleslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:deepslatecobbleslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("deepslatecobbleslab");

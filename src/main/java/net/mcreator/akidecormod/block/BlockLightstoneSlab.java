...
public class BlockLightstoneSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:lightstoneslab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lightstoneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("lightstoneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:lightstoneslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("lightstoneslab");

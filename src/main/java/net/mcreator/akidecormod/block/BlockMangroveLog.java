...
public class BlockMangroveLog extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:mangrovelog")
	public static final Block block = null;
	public BlockMangroveLog(ElementsAkidecorMod instance) {
		super(instance, 195);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mangrovelog"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:mangrovelog", "inventory"));
	}

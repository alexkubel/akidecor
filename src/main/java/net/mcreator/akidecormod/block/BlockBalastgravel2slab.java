...
public class BlockBalastgravel2slab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:balastgravel2slab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("balastgravel2slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("balastgravel2slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:balastgravel2slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("balastgravel2slab");

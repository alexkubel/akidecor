...
public class BlockFlintSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:flintslab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("flintslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("flintslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:flintslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("flintslab");

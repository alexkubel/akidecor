...
public class BlockBambooBlock extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:bamboo_block")
	public static final Block block = null;
	public BlockBambooBlock(ElementsAkidecorMod instance) {
		super(instance, 353);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bamboo_block"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:bamboo_block", "inventory"));
	}

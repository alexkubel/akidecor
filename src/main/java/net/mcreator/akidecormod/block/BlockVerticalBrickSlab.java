...
public class BlockVerticalBrickSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:verticalbrickslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:verticalbrickslab_double")
	public static final Block block_slab_double = null;
	public BlockVerticalBrickSlab(ElementsAkidecorMod instance) {
		super(instance, 47);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("verticalbrickslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("verticalbrickslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:verticalbrickslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("verticalbrickslab");

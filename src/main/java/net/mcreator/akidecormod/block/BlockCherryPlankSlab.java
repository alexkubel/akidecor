...
public class BlockCherryPlankSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:cherryplankslab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cherryplankslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("cherryplankslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:cherryplankslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("cherryplankslab");

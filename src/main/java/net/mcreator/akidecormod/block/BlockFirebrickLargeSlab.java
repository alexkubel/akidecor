...
public class BlockFirebrickLargeSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:firebrick_large_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:firebrick_large_slab_double")
	public static final Block block_slab_double = null;
	public BlockFirebrickLargeSlab(ElementsAkidecorMod instance) {
		super(instance, 336);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("firebrick_large_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("firebrick_large_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:firebrick_large_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("firebrick_large_slab");

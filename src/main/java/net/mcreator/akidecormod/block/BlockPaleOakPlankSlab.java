...
public class BlockPaleOakPlankSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:pale_oak_plank_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:pale_oak_plank_slab_double")
	public static final Block block_slab_double = null;
	public BlockPaleOakPlankSlab(ElementsAkidecorMod instance) {
		super(instance, 350);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pale_oak_plank_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("pale_oak_plank_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:pale_oak_plank_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("pale_oak_plank_slab");

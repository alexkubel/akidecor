...
public class BlockGratestoneSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:gratestoneslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:gratestoneslab_double")
	public static final Block block_slab_double = null;
	public BlockGratestoneSlab(ElementsAkidecorMod instance) {
		super(instance, 35);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gratestoneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("gratestoneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:gratestoneslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("gratestoneslab");

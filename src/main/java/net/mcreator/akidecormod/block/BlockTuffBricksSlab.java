...
public class BlockTuffBricksSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:tuffbricksslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:tuffbricksslab_double")
	public static final Block block_slab_double = null;
	public BlockTuffBricksSlab(ElementsAkidecorMod instance) {
		super(instance, 246);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tuffbricksslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("tuffbricksslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:tuffbricksslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("tuffbricksslab");

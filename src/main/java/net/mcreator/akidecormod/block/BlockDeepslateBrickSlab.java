...
public class BlockDeepslateBrickSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:deepslate_brick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:deepslate_brick_slab_double")
	public static final Block block_slab_double = null;
	public BlockDeepslateBrickSlab(ElementsAkidecorMod instance) {
		super(instance, 260);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("deepslate_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("deepslate_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:deepslate_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("deepslate_brick_slab");

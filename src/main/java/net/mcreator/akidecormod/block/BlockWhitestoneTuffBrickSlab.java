...
public class BlockWhitestoneTuffBrickSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:whitestone_tuff_brick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:whitestone_tuff_brick_slab_double")
	public static final Block block_slab_double = null;
	public BlockWhitestoneTuffBrickSlab(ElementsAkidecorMod instance) {
		super(instance, 311);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("whitestone_tuff_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("whitestone_tuff_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:whitestone_tuff_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("whitestone_tuff_brick_slab");

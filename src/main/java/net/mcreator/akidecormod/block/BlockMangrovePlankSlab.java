...
public class BlockMangrovePlankSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:mangroveplankslab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mangroveplankslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("mangroveplankslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:mangroveplankslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("mangroveplankslab");

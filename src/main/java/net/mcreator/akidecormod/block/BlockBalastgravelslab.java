...
public class BlockBalastgravelslab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:balastgravelslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:balastgravelslab_double")
	public static final Block block_slab_double = null;
	public BlockBalastgravelslab(ElementsAkidecorMod instance) {
		super(instance, 24);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("balastgravelslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("balastgravelslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:balastgravelslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("balastgravelslab");

...
public class BlockBambooPlankSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:bamboo_plank_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:bamboo_plank_slab_double")
	public static final Block block_slab_double = null;
	public BlockBambooPlankSlab(ElementsAkidecorMod instance) {
		super(instance, 357);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bamboo_plank_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("bamboo_plank_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:bamboo_plank_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("bamboo_plank_slab");

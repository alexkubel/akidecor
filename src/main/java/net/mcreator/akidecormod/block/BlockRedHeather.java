...
public class BlockRedHeather extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:redheather")
	public static final Block block = null;
	public BlockRedHeather(ElementsAkidecorMod instance) {
		super(instance, 67);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:redheather", "inventory"));
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (Biome.REGISTRY.getNameForObject(biome).equals(new ResourceLocation("akidecor:nordalianlowland")))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
		for (int i = 0; i < 20; i++) {
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("redheather");
			setRegistryName("redheather");
		}

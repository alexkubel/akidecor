...
public class BlockBrick6slab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:brick6slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:brick6slab_double")
	public static final Block block_slab_double = null;
	public BlockBrick6slab(ElementsAkidecorMod instance) {
		super(instance, 47);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brick6slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("brick6slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:brick6slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("brick6slab");

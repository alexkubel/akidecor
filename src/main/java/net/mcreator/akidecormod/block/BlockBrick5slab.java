...
public class BlockBrick5slab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:brick5slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:brick5slab_double")
	public static final Block block_slab_double = null;
	public BlockBrick5slab(ElementsAkidecorMod instance) {
		super(instance, 39);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brick5slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("brick5slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:brick5slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("brick5slab");

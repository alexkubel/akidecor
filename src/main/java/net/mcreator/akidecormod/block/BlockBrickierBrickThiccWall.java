...
public class BlockBrickierBrickThiccWall extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:brickier_brick_thicc_wall")
	public static final Block block = null;
	public BlockBrickierBrickThiccWall(ElementsAkidecorMod instance) {
		super(instance, 325);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brickier_brick_thicc_wall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:brickier_brick_thicc_wall", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("brickier_brick_thicc_wall");

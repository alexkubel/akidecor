...
public class BlockBrick1slab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:brick1slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:brick1slab_double")
	public static final Block block_slab_double = null;
	public BlockBrick1slab(ElementsAkidecorMod instance) {
		super(instance, 7);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brick1slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("brick1slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("akidecor:brick1slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("brick1slab");

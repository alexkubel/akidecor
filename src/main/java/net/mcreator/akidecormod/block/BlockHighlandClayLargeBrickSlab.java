...
public class BlockHighlandClayLargeBrickSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:highland_clay_large_brick_slab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("highland_clay_large_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("highland_clay_large_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:highland_clay_large_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("highland_clay_large_brick_slab");

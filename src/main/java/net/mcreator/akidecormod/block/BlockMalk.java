...
public class BlockMalk extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:malk")
	...
	public void initElements() {
		...
		}.setUnlocalizedName("malk").setRegistryName("malk"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName("malk"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomMeshDefinition(item, new ItemMeshDefinition() {
			...
			public ModelResourceLocation getModelLocation(ItemStack stack) {
				return new ModelResourceLocation("akidecor:malk", "malk");
			}
		});

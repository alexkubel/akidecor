...
public class BlockHighlandTuffBallastSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:highland_tuff_ballast_slab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("highland_tuff_ballast_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("highland_tuff_ballast_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:highland_tuff_ballast_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("highland_tuff_ballast_slab");

...
public class BlockSootierBrickSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:sootier_brick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:sootier_brick_slab_double")
	public static final Block block_slab_double = null;
	public BlockSootierBrickSlab(ElementsAkidecorMod instance) {
		super(instance, 342);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sootier_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("sootier_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:sootier_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("sootier_brick_slab");

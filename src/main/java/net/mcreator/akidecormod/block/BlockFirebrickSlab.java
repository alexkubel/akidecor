...
public class BlockFirebrickSlab extends ElementsAkidecorMod.ModElement {
	@GameRegistry.ObjectHolder("akidecor:firebrick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("akidecor:firebrick_slab_double")
	public static final Block block_slab_double = null;
	public BlockFirebrickSlab(ElementsAkidecorMod instance) {
		super(instance, 116);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("firebrick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("firebrick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("akidecor:firebrick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("firebrick_slab");

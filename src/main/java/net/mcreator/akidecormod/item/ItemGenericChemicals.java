...
import net.mcreator.akidecormod.procedure.ProcedureGenericChemicalsRightClickedOnBlock;
...
public class ItemGenericChemicals extends ElementsAkidecorMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("akidecor:generic_chemicals", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("generic_chemicals");
			setRegistryName("generic_chemicals");
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing direction, float hitX, float hitY,
			...
			int z = pos.getZ();
			{
				...
				ProcedureGenericChemicalsRightClickedOnBlock.executeProcedure($_dependencies);
			}
			return retval;
		}
	}

...
public class ItemIngotBronze extends ElementsAkidecorMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("akidecor:ingotbronze", "inventory"));
	}

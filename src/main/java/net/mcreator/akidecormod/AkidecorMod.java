 ...
 *
 *    Keep the ElementsAkidecorMod object in this class and all calls to this object
...
public class AkidecorMod {
	...
	@Mod.Instance(MODID)
	public static AkidecorMod instance;
	public ElementsAkidecorMod elements = new ElementsAkidecorMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsAkidecorMod.GuiHandler());
